      ...
      <div class="center">
        ...
        <div class="swiper-container" ref="mySwiper">
          <div class="swiper-wrapper">
            ...
            <div
              class="swiper-slide"
              v-for="(carousel, index) in bannerList.data"
              :key="index"
            >
...
export default {
  ...
  mounted() {
    ...
    // 为什么swiper实例在mounted当中直接书写不可以，因为结构还不完整
    // setTimeout(() => {}, 2000);
  },
  computed: {
    // 使用vuex身上的数据，使用mapState来进行映射操作
    ...mapState({
  ...
  watch: {
    // 现在我们通过watch监听bannerList数据的变化：因为这条数据发生过变化，由空数组 => 数组里面有四个元素
    bannerList: {
      immediate: true,
      handler(newValue, oldValue) {
        /* 
          watch
          现在我们通过watch监听bannerList属性的属性值的变化
        ...
        */
        // nextTick:下次Dom更新 循环结束之后 执行延迟回调，在 修改数据之后 立即使用这个方法，获取更新后的Dom
        this.$nextTick(() => {
