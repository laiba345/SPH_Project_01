  ...
  export default {
    ...
    methods: {
      ...
      tradeMarkHandler(trademark) {
        // 点击了解品牌(苹果) 还是需要整理参数，向服务器发送请求获取相应的数据进行展示
        // 老师的问题？ 子 / 父 组件发请求  答：父组件
        // 因为父组件中searchParams参数是带给服务器参数，子组件把你点击的品牌信息需要给父组件传递过去
        // 子给父传递 自定义事件来解决
      ...
      attrInfo(attr, attrValue) {
        ...
        // 还是子给父传内容，所以采取的还是自定义事件来进行相应的模拟操作
